...
{
    public class BookAddedNeedToAssignPublisherDomainEventHandler : INotificationHandler<AssignBookToPublisherDomainEvent>
    {
        ...
        public async Task Handle(AssignBookToPublisherDomainEvent notification, CancellationToken cancellationToken)
        {
